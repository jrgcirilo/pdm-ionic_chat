...
export class HomePage {
  ...
  public login(): void {
    this.firebaseauth.auth.signInWithEmailAndPassword(this.email.value , this.password.value)
      ...
      .catch((erro: any) => {
        this.showToast("Usuário inexistente ou a senha está incorreta!");
      });
  }
  ...
  public cadastro(): void {
    ...
    .catch((erro: any) => {
      this.showToast("Usuário existente, ou o email foi digitado incorretamente ou a senha não possui 8 caracteres!", 9000);
    });
  }
